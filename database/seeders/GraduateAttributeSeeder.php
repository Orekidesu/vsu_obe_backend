    ...
    public function run(): void
    {
        DB::table('graduate_attributes')->insert([
            [
                'ga_no' => '1',
                'name' => 'Competence',
                'description' => 'Graduates possess relevant knowledge, skills, and attitudes needed in their chosen fields, and can apply these in the practice of their profession and in giving service to the community.'
            ],
            [
                'ga_no' => '2',
                'name' => 'Resilience and Endurance',
                'description' => 'Graduates are flexible, adaptable, and steadfast when facing challenging life situations.'
            ],
            [
                'ga_no' => '3',
                'name' => 'Critical Thinking Skills',
                'description' => 'Graduates are reflective and can critically analyze and evaluate facts, observations, and differing opinions to arrive at a sound judgment or conclusion.'
            ],
            [
                'ga_no' => '4',
                'name' => 'Effective Communication Skills',
                'description' => 'Graduates can communicate information and ideas effectively and express needs and opinions clearly to varied audiences.'
            ],
            [
                'ga_no' => '5',
                'name' => 'Leadership Skills',
                'description' => 'Graduates act professionally, and ethically, and can assume effective leadership roles in their chosen careers and in society.'
            ],
            // [
            //     'ga_no' => '1',
